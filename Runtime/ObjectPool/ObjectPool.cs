...
namespace MokomoGamesLib.Runtime.ObjectPool
{
    public class ObjectPool : MonoBehaviour
    {
        [SerializeField] private List<MonoBehaviour> prefabs = new();
        [SerializeField] private GameObject poolRoot;

        private readonly Dictionary<Type, List<MonoBehaviour>> _poolableDictionary = new();
        ...
        {
            if (obj is IReleaseable releasable) releasable.Release();
